...
public interface ThemeService {
    ...
    void addTheme (Map<String, String> localizedNames) throws ThemeServiceException;
    void updateTheme (int id, Map<String, String> localizedNames) throws ThemeServiceException;
